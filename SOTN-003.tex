...
\begin{table*}
\centering
\caption{Hexapod perturbations applied:}
\label{tab:hexapods}
\begin{tabular}{c|c|c}
\hline
Hexapod $z$ &
...
\begin{table*}
\centering
\caption{Bending mode perturbations applied:}
\label{tab:bending}
\begin{tabular}{cc}
\hline
M2 Bending Modes &
...
Data for this investigation comprised of 117 exposures, which were examined by eye and formatted into an \texttt{astropy.table.Table} object. 
Columns of the \texttt{Table} object consisted of information pulled out of the \texttt{ConsDB}
